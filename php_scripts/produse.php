...
$sql="SELECT * FROM  $tbl_name WHERE  `stoc_produs` <>0 ORDER BY RAND() LIMIT 0 , 18";
		...
		<div class="col-md-3 col-sm-6 masonry-grid-item">
			<div class="listing-item white-bg bordered mb-20">
				<div style="padding:50px;">
					<font color="red"><i class="fa fa-exclamation-triangle"></i> Nu exista rezultate. Probabil este o problema la conexiunea cu baza de date ...</font>
				</div>
			</div>
		</div>';
}else
{
	while($row = $result->fetch_assoc()) {
		...
		echo '	
			<div class="col-md-3 col-sm-6 masonry-grid-item" style="width:200px;">
				<div class="listing-item white-bg bordered mb-20">
